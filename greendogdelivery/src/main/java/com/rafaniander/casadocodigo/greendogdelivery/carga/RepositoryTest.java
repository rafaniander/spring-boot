package com.rafaniander.casadocodigo.greendogdelivery.carga;
...
public class RepositoryTest implements ApplicationRunner {
    ...
    private static final long ID_CLIENTE_FERNANDO = 11;
    private static final long ID_CLIENTE_ZE_PEQUENO = 22;

    private static final long ID_ITEM1 = 100;
    private static final long ID_ITEM2 = 101;
    private static final long ID_ITEM3 = 102;

    private static final long ID_PEDIDO1 = 1000;
    private static final long ID_PEDIDO2 = 1001;
    private static final long ID_PEDIDO3 = 1002;
